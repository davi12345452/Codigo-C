...
int main(){
    ...
    somador = 0; //Valor atribuído após o resto da divisão com os divisores e o rand
    srand(time(0));
    ...
    while (true) {
        ...
        */
        ...
        /*Lógica do programa: se chutou igual, cabe ao usuário indicar e o laço acaba.
          Se o chute for maior, o divisor míximo passa a ser esse valor
    ...
    printf("\nComputador acertou o numero %d com %d chutes.\n", chute, contador); //Saída do programa com o número e as chances usadas
